...
export class PlotlyPlotter {
    static plotIndividualData(plotDivId, potentials, rawCurrents, smoothedCurrents, regressionLine, adjustedPotentials, aucVertices, selectedOptions, peakInfo = null, peakBaselineLine = null, voltageUnits = 'V', currentUnits = 'A') {
        const traces = [];
        ...
        const layout = {
            ...
            yaxis: { title: `Current (${currentUnits})`, autorange: true, rangemode: 'normal', exponentformat: 'SI' },
    ...
    static renderFullTrendPlot(plotDivId, data, freqStrings, xAxisTitle, yAxisTitle, numFiles, title, trendType, xAxisUnits, resizeInterval, kdmHighFreq = null, kdmLowFreq = null, injectionPoint = null) {
        ...
        const layout = {
            ...
            yaxis: { title: yAxisTitle, autorange: true, exponentformat: 'SI' },
