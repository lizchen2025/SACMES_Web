...
# This setup ensures logs are captured reliably in a cloud environment.
...
# Enable detailed logging for Socket.IO to diagnose connection issues
...
def process_file_in_background(original_filename, content, params_for_this_file):
    ...
    try:
        ...
        if web_viewer_sids:
            socketio.emit('live_analysis_update', {"filename": original_filename, "individual_analysis": analysis_result, "trend_data": full_trends}, to=list(web_viewer_sids), broadcast=True)
